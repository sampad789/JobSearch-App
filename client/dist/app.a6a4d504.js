  ...
  _createClass(JobSearch, [{
    ...
    value: function configureFormListener() {
      ...
      this.searchForm.addEventListener("submit", function (event) {
        ...
        fetch("http://localhost:8000/?search=".concat(search, "&location=").concat(location, "&country=").concat(_this2.countryCode)).then(function (response) {
          ...
          return _this2.stopLoading() & _this2.sendServerAlert();
        });
      });
    }
  }, {
    ...
    key: "sendServerAlert",
    value: function sendServerAlert() {
